        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-justify md:text-left">
            ...
            <p className="text-justify text-gray-600">
              My approach: user-centered creative thinking with technical skills, ensuring every project not only looks great but also performs exceptionally well at the same time.
            </p>
          </div>
        </div>
      </div>
