        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg text-gray-600 mb-6">
              I'm a passionate designer with expertise in creating digital experiences that connect brands with their users. With years of experience in graphic design and UI/UX design, I transform ideas into reality.
            </p>
