...
export default function Technologies() {
  ...
  return (
    <section
      id="technologies"
      className="snap-section relative z-10 flex min-h-dvh flex-col justify-center gap-6 overflow-x-visible px-4 pt-10 pb-2 sm:gap-8 sm:px-6 sm:pt-12 sm:pb-4 md:gap-10 md:pt-16 md:pb-6"
    >
